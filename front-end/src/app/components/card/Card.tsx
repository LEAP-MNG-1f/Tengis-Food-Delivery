...
import OpenDilog from "./OpenDilog";
...
export default function Carda() {
  ...
  return (
    <div className="w-full h-full">
      <div
        className="bg-[#18BA51] w-full h-[788px] mt-10 flex items-center  justify-center gap-[250px]"
        style={{
      ...
      >
        ...
        <div className=" flex items-end pr-40">
          <img src="./budaa.png" className="w-[588px] h-[438px]" />
        </div>
      </div>
        ...
        <Card sx={{ maxWidth: 264, height: 155 }}>
          <CardContent>
            <button>
              ...
              >
                <path
                  d="M30.75 15.2188C22.7227 15.2188 16.2188 21.7227 16.2188 29.75C16.2188 37.7773 22.7227 44.2812 30.75 44.2812C38.7773 
...
42.4062 30.75 42.4062C23.7773 42.4062 18.0938 36.7812 18.0938 29.75C18.0938 22.8359 23.7188 17.0938 30.75 17.0938C37.6641
 ...
 20.8438 29.6367 21.1953 29.6367 21.5469V30.9219C29.6367 31.1562 29.6953 31.332 29.8711 31.5078L34.6758 34.9648Z"
                  fill="#18BA51"
                />
              </svg>
            </button>
        ...
        <Card sx={{ maxWidth: 264, height: 155 }}>
          <CardContent>
            <button>
              ...
              >
                <path
                  d="M44.5039 31.625H44.7969C45.207 30.8047 45.4414 29.8672 45.5 28.8125C45.5 26.8789 44.6211 
            ...
            43.9297 23.8203 44.75 24.875 44.75H36.125C37.1797 44.75 38 43.9297 38 42.875V42.2305C42.043 40.7656 45.0898 37.0742
             ...
             43.625 26.2344 43.625 28.8125ZM17.375 26C17.375 23.9492 18.7227 19.9062 24.875 20.375C26.457 16.6836 28.6836 16.625 29.5625
              ...
              23.7148 21.7695 23.7148C21.6523 23.7148 21.5352 23.7148 21.418 23.832L20.7734 24.4766C20.6562 24.5938 20.5977 24.7109 20.5977 24.8281C20.5977
               ...
               40.4727C20.4805 39.3594 18.1367 36.7227 17.4922 33.5H43.4492C42.8047 36.7227 40.5195 39.3594 37.3555 40.4727Z"
                  fill="#18BA51"
                />
              </svg>
            </button>
        ...
        <Card sx={{ maxWidth: 264, height: 155 }}>
          <CardContent>
            <button>
              ...
              >
                <path
                  d="M40.3477 18.6875C39.1758 18.7363 33.3164 19.127 29.6543 21.0801C29.459 21.1777 29.1172 21.1777 28.9219 21.0801C25.2598 19.127 19.4004 18.7363 18.2285 
           ...
           41.7637 20.8848 41.7637 21.6172V36.0703H41.8125Z"
                  fill="#18BA51"
                />
              </svg>
            </button>
