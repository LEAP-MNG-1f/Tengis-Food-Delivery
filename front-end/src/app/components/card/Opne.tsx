        ...
        <div className="flex gap-10 justify-center">
                  ...
                  >
                    ...
                    <DialogContent dividers>
                      <div className="flex">
                        ...
                        <div className="flex flex-col mt-10 ml-10 w-[385px] h-[385px]">
                          <div>
                            <h1 className="font-bold text-[28px]">Lunch</h1>
                            <h1 className="text-green-500 text-[24px]">
                              24,800₮
                            </h1>
                          </div>
                  ...
                  >
                    ...
                    <DialogContent dividers>
                      <div className="flex">
                        ...
                        <div className="flex flex-col mt-10 ml-10 w-[385px] h-[385px]">
                          <div>
                            <h1 className="font-bold text-[28px]">Сэндвич</h1>
                            <h1 className="text-green-500 text-[24px]">
                              14,800₮
                            </h1>
                          </div>
          ...
          <div className="flex gap-10 justify-center">
            <div className="flex flex-col  justify-center mt-10 w-[282px] h-[253px]">
                  ...
                  >
                    ...
                    <DialogContent dividers>
                      <div className="flex">
                        ...
                        <div className="flex flex-col mt-10 ml-10 w-[385px] h-[385px]">
                          <div>
                            <h1 className="font-bold text-[28px]">Apple pie</h1>
                            <h1 className="text-green-500 text-[24px]">
                              34,800₮
                            </h1>
                          </div>
              ...
              <CardContent>
                <h1 className="font-bold">Apple pie</h1>
                <div className="flex gap-3">
